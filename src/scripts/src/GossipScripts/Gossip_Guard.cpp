...
public:
    ...
    void GossipHello(Object* pObject, Player * Plr, bool AutoSend)
    {
		...
		Menu->AddItem(0, "Faldayn ( Port NPC )", 100);
		Menu->AddItem(0, "Training dummy", 101);
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(-8972.0, 892.7, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
        case 101: //Training dummy
            {
                Plr->Gossip_SendPOI(-8707.40, 349.34, 6, 6, 0, "Training dummy");
                SendQuickMenu(50119);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(9960.29, 2513.76, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(1491.38, 135.51, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(9598.52, -7081.86, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(-4031, -11873.76, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(1519.44, -4170.26, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
        case 101: //Training dummy
            {
                Plr->Gossip_SendPOI(1945.75, -4289.66, 6, 6, 0, "Training dummy");
                SendQuickMenu(50119);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(-1139.39, 8.11, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
        }
    }
...
public:
    ...
    void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn
            {
                Plr->Gossip_SendPOI(-4670.6, -962.31, 6, 6, 0, "Faldayn ( Port NPC )");
                SendQuickMenu(50115);
            }break;
        }
    }
...
public:
    ...
    void GossipHello(Object* pObject, Player * Plr, bool AutoSend)
    {
		...
		Menu->AddItem(0, "Dungeon Master ( Port NPC )", 100);
   ...
   void GossipSelectOption(Object* pObject, Player* Plr, uint32 Id, uint32 IntId, const char * Code)
    {
        ...
        case 100: //Faldayn - Dungeon master
            {
                Plr->Gossip_SendPOI(-1893.63, 5389.01, 6, 6, 0, "Dungeon Master ( Port NPC )");
                SendQuickMenu(50117);
            }break;		
