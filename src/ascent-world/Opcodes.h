...
enum Opcodes {
	...
	NUM_MSG_TYPES											= 1060, //(0x424)
};

extern const char *g_wowClientOpcodes[NUM_MSG_TYPES];
inline static const char *LookupOpcodeName(uint32 id)
{
	if( id >= NUM_MSG_TYPES )
		return "(null)";
	
	return g_wowClientOpcodes[id];
}
...
//									Decimal                    Hex     Bit  Comments
	...
	UNIT_NPC_FLAG_UNK1				=	4,				 //0x00000004	04
	UNIT_NPC_FLAG_UNK2				=	8,				 //0x00000008	05
	UNIT_NPC_FLAG_TRAINER			=	16,				 //0x00000010	06	Trainer (CMSG_TRAINER_LIST, SMSG_TRAINER_LIST)
	UNIT_NPC_FLAG_TRAINER_CLASS		=	32,				 //0x00000020	07
	UNIT_NPC_FLAG_TRAINER_PROF		=	64,				 //0x00000040	08
	UNIT_NPC_FLAG_VENDOR			=	128,			 //0x00000080	09	Vendor (CMSG_LIST_INVENTORY, SMSG_LIST_INVENTORY)
	UNIT_NPC_FLAG_VENDOR_AMMO		=	256,			 //0x00000100	10
	UNIT_NPC_FLAG_VENDOR_FOOD		=	512,			 //0x00000200	11
	UNIT_NPC_FLAG_VENDOR_POISON		=	1024,			 //0x00000400	12
	UNIT_NPC_FLAG_VENDOR_REAGENT	=	2048,			 //0x00000800	13
	UNIT_NPC_FLAG_ARMORER			=	4096,			 //0x00001000	14
	UNIT_NPC_FLAG_TAXIVENDOR		=	8192,			 //0x00002000	15	Taxi Vendor (CMSG_TAXIQUERYAVAILABLENODES, SMSG_SHOWTAXINODES)
	UNIT_NPC_FLAG_SPIRITHEALER		=	16384,			 //0x00004000	16	Spirithealer (CMSG_BINDER_ACTIVATE, ?)
	UNIT_NPC_FLAG_SPIRITGUIDE		=	32768,			 //0x00008000	17
	UNIT_NPC_FLAG_INNKEEPER			=	65536,			 //0x00010000	18	Innkeeper Asking for Bind Point
	UNIT_NPC_FLAG_BANKER			=	131072,			 //0x00020000	19	Banker
	UNIT_NPC_FLAG_ARENACHARTER		=	262144,			 //0x00040000	20	GuildMasters also have UNIT_NPC_FLAG_TABARDCHANGER!!
	UNIT_NPC_FLAG_TABARDCHANGER		=	524288,			 //0x00080000	21	Tabard Design Changer Flag
	UNIT_NPC_FLAG_BATTLEFIELDPERSON	=	1048576,		 //0x00100000	22	BattleMaster (CMSG_BATTLEMASTER_HELLO (0x02D7))
	UNIT_NPC_FLAG_AUCTIONEER		=	2097152,		 //0x00200000	23	Auctioneer (MSG_AUCTION_HELLO)
	UNIT_NPC_FLAG_STABLEMASTER		=	4194304,		 //0x00400000	24	(MSG_LIST_STABLED_PETS (0x026F))
	UNIT_NPC_FLAG_GUILD_BANK		=	8388608,		 //0x00800000	25
};
*/
