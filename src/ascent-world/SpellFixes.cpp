...
/*	sp = dbcSpell.LookupEntryForced( 13160 );
	...
	*/
	...
	//Mage - Arcane Potency
	// TUDIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII!!!!!! - Burlex
	...
	sp = dbcSpell.LookupEntryForced( 31573 );
	if( sp != NULL )
	{
		//sp->EffectSpellGroupRelation[0] = 1 | 8192 | 4194304 | 8388608 | 262144 | 131072 | 536870912 | 524352 | 4 | 4096 | 2 | 2048 | 16;
		sp->EffectSpellGroupRelation[0] = 2;
	...
	if( sp != NULL )
	{
		sp->EffectApplyAuraName[0] = SPELL_AURA_DUMMY;//Bfx:Forcing a dummy aura, so we can add the missing 4th effect. Immunity
		sp->Effect[1] = 0;
		sp->Effect[2] = 0;
	}
	...
	*/
	...
	// shaman - ghost wolf
	//sp = dbcSpell.LookupEntryForced(2645);
	//if( sp != NULL )
	//	sp->Attributes |= ATTRIBUTES_MOUNT_CASTABLE;
	...
	if( sp != NULL )
	{
	   ...
	   //Energized 
		...
		if( sp != NULL )
		{
			...
			sp->procChance = 20;
			sp->proc_interval = 60000;
			sp->EffectTriggerSpell[0] = 40477;
		}
		
		//Blackened Naaru Silver
		sp = dbcSpell.LookupEntryForced( 45040 );
		if( sp != NULL )
		{
	...
	**********************************************************/
	...
	//Encapsulate Channel	
    sp = dbcSpell.LookupEntryForced( 45661 );
    if( sp != NULL )
    {     
      sp->EffectTriggerSpell[0] = 45665;
	  sp->Effect[2] = 6;
      sp->EffectApplyAuraName[1] = 201;
    }
